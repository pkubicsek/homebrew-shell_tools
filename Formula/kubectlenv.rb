class Kubectlenv < Formula
  ...
  url "git@github.com-pkubicsek:pkubicsek/homebrew-shell_tools.git", tag: "v1.0.0", revision: "8ed5062f138a7eb1dda01b6972655e3311393bd6"
  license "MIT"
  version "1.0.0"
  head "git@github.com-pkubicsek:pkubicsek/homebrew-shell_tools.git", branch: "master"
